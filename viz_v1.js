  ...
  if (!window.tableau._apiLoaded) {
    ...
    (function () {
      ...
      function calculateServerRootFromObjectParameters(opts) {
        ...
        var protoRegex, baseWindowProto, serverRoot, publicHostRegex;
        ...
        publicHostRegex = new RegExp("https?:\/\/[-A-Za-z0-9]*public[-A-Za-z0-9]*\\.tableau");
		...
		// TFSID 387989 - Only do the following replace if the server root looks like a Tableau Public host
		// e.g. qa-public.tableausoftware.com, public.tableau.com, public-upgrade.tableausoftware.com
        if ((baseWindowProto.indexOf("file://") === -1) && (serverRoot.indexOf(baseWindowProto) === -1) &&
		        serverRoot.match(publicHostRegex) !== null) {
