...
(function(){
    var h = '<div id="helpLoad">If the Tableau dashboard fails to load below then a) <a href="https://sbmcin.analytics.healtheintent.com/discovery" target="_blank">Make sure you\'re loogged in</a>, and then b) <button id="reload" class="btn-primary">reload this app</button>.</div>'
